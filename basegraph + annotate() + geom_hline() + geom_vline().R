...
# Add abline with geom_hline() and geom_vline():

basegraph
basegraph + geom_hline( yintercept = 32, size = 2, color = 'red') + 
  geom_vline(xintercept = 4.5, color = 'red', size = 2)

# Add a point and range with pointrange:

basegraph + annotate('pointrange', x = 3, y = 20, ymin = 12, ymax = 30)
